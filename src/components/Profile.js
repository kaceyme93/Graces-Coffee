      ...
      <div className="row">
        <div className="col-md-3" style={{borderRight:"1px solid black"}}>
          <div className="d-flex flex-column align-items-center text-center p-3 py-5">
            <img className="rounded-circle mt-5" width="150px" height="150px" src={userInfo.imageURL} alt='coffee'/>
        ...
        {updating ? 
                ...
                <div className="p-3 py-5">
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-md-12"><label className="labels">Zip code</label><input type="text" className="form-control" placeholder="enter zip code" value=""/></div>
                    </div>
                    <div className="mt-5 text-center"><button className="btn btn-primary profile-button" type="button"onClick={(e)=>{
                  e.preventDefault();
                  setUpdating(false);
        ...
        <div className="col-md-7" style={{borderRight:"1px solid black"}}>
            <div className="p-3 py-5">
                ...
                <div className="row mt-2">
                    <div className="col-md-6"><label className="labels">First name</label><div className="form-control">{userInfo.firstName}</div></div>
                    <div className="col-md-6"><label className="labels">Last name</label><div className="form-control">{userInfo.lastName}</div></div>
                </div>
                <div className="row mt-3">
                    <div className="col-md-12"><label className="labels">Mobile Number</label><input type="text" className="form-control" placeholder="enter phone number" value=""/></div>
                    <div className="col-md-12"><label className="labels">Address Line 1</label><input type="text" className="form-control" placeholder="enter address line 1" value=""/></div>
